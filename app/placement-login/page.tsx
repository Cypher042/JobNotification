...
export default function LoginPage() {
  ...
  async function onSubmit(values: LoginValues) {
    ...
    try {
      const res = await fetch("/api/auth/placement/login", {
        method: "POST",
      ...
      router.push("/job-notification-form"); 
    } catch (err: unknown) {
        ...
        <div className="max-w-[450px] w-full mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-6">
            ...
            <div className="text-center w-full mt-6">
              ...
              <Link href="/placement-register" className="text-blue-600 text-sm font-semibold hover:underline">
                Register here
              </Link>
            </div>
          </form>
